	...
	<body>
		<div id="main_container">
			...
			<div id="header">
				...
				<div id="share_icons">
					<img id="fb_share_icons" src="<?php  echo HTTP_IMG_PATH; ?>/heade_find_us_f.png" />
					<img id="tw_share_icons" src="<?php  echo HTTP_IMG_PATH; ?>/heade_find_us_t.png" />
					<img id="yt_share_icons" src="<?php  echo HTTP_IMG_PATH; ?>/heade_find_us_y.png" />
